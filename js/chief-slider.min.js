...
ChiefSlider.prototype._addEventListener = function() {
  ...
  t.addEventListener("click", function(t) {
    var i = t.target;
    if (this._autoplay("stop"), i.classList.contains(CONTROL_CLASS)) t.preventDefault(), this._direction = i.dataset.slide, this._move();
  ...
  var s, r, a, n = [],
    o = 0;
  if ("next" === this._direction)
    for (o = 0, s = this._activeItems.length; o < s; o++) r = this._activeItems[o], (a = ++r) > this._$itemList.length - 1 && (a -= this._$itemList.length), n.push(a);
  else
    for (o = 0, s = this._activeItems.length; o < s; o++) r = this._activeItems[o], (a = --r) < 0 && (a += this._$itemList.length), n.push(a);
  this._activeItems = n, this._setActiveClass(), this._updateIndicators(), this._transform = i, this._$items.style.transform = "translateX(" + i + "%)", this._$items.dispatchEvent(new CustomEvent("transition-start", {
    bubbles: !0
  }))
  ...
  var i, e, s = this._$indicatorList,
    r = null,
    a = null;
  ...
  if (0 !== (a = t - r))
    for (this._direction = a > 0 ? "next" : "prev", i = 1; i <= Math.abs(a); i++) this._move()
  ...
  if (s !== this._itemsInVisibleArea) {
    ...
    if (this._setActiveClass(), this._updateIndicators(), window.requestAnimationFrame(function() {
      ...
      var h = t.length - 1,
        _ = 100 * -t.length;
      t[h].dataset.order = -1, t[h].dataset.translate = 100 * -t.length, t[h].style.transform = "translateX(".concat(_, "%)"), this.__refreshExtremeValues(), this._autoplay()
    } else this._$controlPrev && this._$controlPrev.classList.add(CLASS_CONTROL_HIDE)
  }
